...
public class TradingPostOrientBoardDtoTest {

  TradingPostOrientBoardDto tradingPostBoardDto;
  ...
  public void setup() throws InvalidCardType {
    ...
    tradingPostBoardDto = new TradingPostOrientBoardDto(10, 20, 30, faceUpCards, 5, 5, 5, faceUpOrientCards, availableGems, nobles, tradingPosts);
  }
